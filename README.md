...
The Python script uses a fixed random seed, so the data is fully reproducible. Run `python generate_data.py` and you'll get the same numbers I worked with.
